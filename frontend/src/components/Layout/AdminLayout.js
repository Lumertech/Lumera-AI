...
import { Shield, Users, BarChart3, FileText, LogOut, Home } from 'lucide-react';
...
const AdminLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Sidebar */}
      <div className="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white">
        <div className="p-6">
