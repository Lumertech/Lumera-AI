...
# Auth routes now live in routes/auth.py


# Appointments/Clients/Vitals routes now live in routes/appointments.py
...
# Mount extracted routers under /api (Phase 1-3 refactor)
from routes import prescriptions as _prescriptions_router_mod
from routes import consultations as _consultations_router_mod
from routes import clinics as _clinics_router_mod
from routes import hexa as _hexa_router_mod

app.include_router(_prescriptions_router_mod.router, prefix="/api")
...
from routes import invoices as _invoices_router_mod
...
from routes import safety as _safety_router_mod
app.include_router(_safety_router_mod.router, prefix="/api")
...
from routes import auth as _auth_router_mod
app.include_router(_auth_router_mod.router, prefix="/api")
